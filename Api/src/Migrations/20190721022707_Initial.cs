        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DebateId1 = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Profile_Gender = table.Column<string>(nullable: false),
                    Profile_ImageUrl = table.Column<string>(nullable: true),
                    Profile_Ideology = table.Column<string>(nullable: true),
                    Profile_Country = table.Column<string>(nullable: false),
                    Profile_State = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Debates_Users_CreatedById",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Comments_Debates_DebateId1",
                table: "Comments",
                column: "DebateId1",
                principalTable: "Debates",
                principalColumn: "Id",
